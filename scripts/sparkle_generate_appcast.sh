...
# [TextBox] Point to fork releases
DOWNLOAD_URL_PREFIX="${DOWNLOAD_URL_PREFIX:-https://github.com/alumican/cmux-tb/releases/download/$TAG/}"
RELEASE_NOTES_URL="${RELEASE_NOTES_URL:-https://github.com/alumican/cmux-tb/releases/tag/$TAG}"
